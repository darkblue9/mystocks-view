/**
 * Naver Stock Proxy Server (CommonJS, UTF-8 safe version)
 * Run: node naver-proxy-fixed.cjs
 */
...
app.listen(PORT, ()=> console.log(`✅ Naver proxy ready on http://localhost:${PORT}`));
